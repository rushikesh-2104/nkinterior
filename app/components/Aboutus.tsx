    ...
    <section className="bg-[#FAF5EF] px-5 md:px-20">
      <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-[#FAF5EF]">
        ...
        <motion.div variants={staggerParent} className="sm:-ml-20 bg-[#FAF5EF]">
          <motion.h2 variants={fadeUp} className="text-5xl md:text-6xl text-center font-serif text-gray-800 mb-4 sm:-mt-30">
            About Us
          </motion.h2>
          <motion.p variants={fadeUp} className="text-[#C17F59] text-center text-xl mb-12">
        ...
        <motion.div variants={staggerParent} className="grid grid-cols-2 grid-rows-1 gap-4 md:ml-10 md:-mr-20 bg-[#FAF5EF]">
          <motion.div variants={fadeUp}>
            <div className="grid grid-cols-1 grid-rows-2 gap-4">
              <div className="flex flex-col justify-end">
                <motion.div variants={fade} className="bg-blue-200 h-48 object-cover rounded-lg shadow-md ">
                  <img src="/Aboutus_img_2.png" className="w-full h-full object-cover" alt="" />
                </motion.div>
              </div>
              <div>
                <motion.div variants={fade} className="bg-blue-200 h-96 object-cover rounded-lg shadow-md ">
          ...
          <motion.div variants={fade} className="py-24">
            <div className="grid grid-cols-1 grid-rows-2 gap-4">
              <div>
                <motion.div variants={fade} className="bg-blue-200 h-96 object-cover rounded-lg shadow-md ">
...
//       <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-[#FAF5EF]">
//         {/* --- Left Section (Text) --- */}
//         <div className="sm:-ml-20 bg-[#FAF5EF]">
//           <h2 className="text-5xl md:text-6xl text-center font-serif text-gray-800 mb-4 sm:-mt-30">
//             About Us
//           </h2>
//           <p className="text-[#C17F59] text-center text-xl mb-12">
//             At NK Interiors, we take pride in our values — exquisite design, attention to detail, and a commitment to unparalleled excellence.
//           </p>
...
//         {/* --- Right Section (Image Grid) --- */}
//         <div className="grid grid-cols-2 grid-rows-1 gap-4 sm:ml-10 sm:-mr-20 bg-[#FAF5EF]">
//           <div>
//             <div className="grid grid-cols-1 grid-rows-2 gap-4">
//               <div className="flex flex-col justify-end">
//                 <div className="bg-blue-200 h-48 object-cover rounded-lg shadow-md ">
//                   <img src="/Aboutus_img_2.png" className="w-full h-full object-cover" alt="" />
//                 </div>
//               </div>
//               <div>
//                 <div className="bg-blue-200 h-96 object-cover rounded-lg shadow-md ">
//                   <img src="/Aboutus_img_1.png" className="w-full h-full object-cover" alt="" />
//                 </div>
//               </div>
//             </div>
