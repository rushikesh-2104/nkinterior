...
const Contactus = () => {
  return (
    <div>
      <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 py-12 bg-gray-50 text-gray-800">
  ...
  <div className="flex flex-col items-center justify-center gap-8 text-center px-4">
    ...
    <p className="text-lg md:text-2xl font-medium max-w-2xl">
      Contact us htmlFor any further questions, possible projects, and business partnerships.
    </p>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl">
      ...
      <div className="flex flex-col gap-3 p-4 rounded-xl shadow-sm shadow-gray-400 bg-white hover:shadow-md transition duration-300">
        ...
        <a href="#" className="font-semibold text-blue-600 hover:underline">Get Directions</a>
      </div>
    </div>
  </div>
      ...
      <div className="relative bg-white border border-gray-300 shadow-xl rounded-2xl p-6 sm:p-8">
        <form className="flex flex-col gap-5">
          ...
          <div className="flex justify-end">
            <button type="submit"
                    className="px-6 py-2 bg-gray-300 border-2 border-gray-400 rounded-xl font-semibold hover:bg-gray-400 hover:border-gray-500 hover:scale-105 transition duration-300">
              Send
            </button>
          </div>
        </form>
