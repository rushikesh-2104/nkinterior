    ...
    <section className="py-16 bg-[#FAF5EF]">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          initial="show"
          animate="show"
          className="mt-10 grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none md:grid-cols-3 lg:gap-10"
        >
          <AnimatePresence>
            {projects.slice(0, visibleCount).map((project) => (
              <motion.div
                ...
                className="bg-[#F9F4EC] h-auto w-full rounded-xl border-2 border-[#D9C9B6] shadow-sm"
              >
                <div
                ...
                <div className="px-5 pb-5">
                  ...
                  <motion.button
                    ...
                    className="text-sm font-medium text-amber-600 cursor-pointer hover:underline"
                  >
                    READ MORE ➜
                  </motion.button>
                </div>
        ...
        <div className="mt-8 text-center md:mt-16">
          {visibleCount < projects.length ? (
            <motion.button
              ...
              className="px-6 py-2 bg-[#EDE3D5] border-2 border-[#C49A6C] rounded-xl font-semibold text-[#1A1A1A] hover:bg-[#F4EADB] transition duration-300"
              onClick={loadMore}
            >
              Load More ↓
            </motion.button>
