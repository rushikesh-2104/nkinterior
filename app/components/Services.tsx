    ...
    <section className="py-16 bg-[#FAF5EF]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-serif text-[#1A1A1A] mb-8 text-center"
        >
          Services Offered
        </motion.h1>
        ...
        <motion.p
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.2 }}
          className="mb-12 text-lg font-medium text-[#7A6852] text-center"
        >
          Elevate your space. We offer a comprehensive suite of design and
          remodeling services to transform your vision into reality.
        </motion.p>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute top-1/2 left-6 transform -translate-y-1/2 bg-[#FFFFFFCC] backdrop-blur-sm p-6 rounded-lg shadow-sm max-w-xs">
                ...
                <p className="text-[#7A6852] text-sm mt-2">{service.price}</p>
                ...
                <p className="text-xs text-[#B8AFA6] mt-3">{service.note}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
